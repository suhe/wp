...
class Database {
	...
	public function query($query,$args = null) {
		if(is_null($args)) {
			...
			if($smt = $this->obj->prepare($query)) {
				...
				if(call_user_func_array(array($smt,"bind_param"),$this->refValues($args)) ) {
					$smt->execute();
	...
	public function fetch_field_direct($field) {
	...
	public function fecth_row() {
		return $this->result->fetch_row();
	}

	public function field_seek($field) {
